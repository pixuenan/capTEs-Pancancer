def get_region_ls_wd(wildcards):
    ...
    return ["{}{}/obj/{}.trans.dict.obj".format(config["path"]["remapping"], wildcards.sample_name, i) for i in inter_df["region"].tolist()]

rule link_gff:
    input:
        file_ls=get_region_ls_wd
    output:
